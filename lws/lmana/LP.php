...
echo "<br />";
 echo "Your total LP is ",$rs['TOTAL_LP'];
echo "<br />","<br />","<br />";


$result = mysql_query("SELECT * FROM Record where RECORD_USERID = $userid AND rtype = 'LP'");

echo "Here are your Learning Points records:","<br />","<br />";							
